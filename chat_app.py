...
async def on_chat_start():
    ...
    retriever_tool = create_retriever_tool(
        retriever,
        "search_documents",
        "Searches and returns excerpts from documents that contain useful information for analysis and finance.",
    )
    ...
    code_interpreter_tool.description += ( " USE PANDAS, NUMPY, SKLEARN, STACKED ENSEMBLE MODEL (RANDOM FOREST WITH GRADIENT BOOST REGRESSOR) "
    "TO PREPROCESS, ANALYZE, TRAIN-TEST PREDICT THE MODEL AND USE ITS PREDICTIONS. "
    "DISPLAY THE RESULTS USING PLOTLY AND MATPLOTLIB. "
    "To see the result, you MUST use the `print` function.")
